    ...
    try {
      ...
      _localStream = await navigator.mediaDevices.getUserMedia({
        ...
        'video': {
          ...
          'width': {'min': cfg.width, 'ideal': cfg.width},
          'height': {'min': cfg.height, 'ideal': cfg.height},
      ...
      for (final track in _localStream!.getTracks()) {
        if (track.kind == 'video') {
          // scaleResolutionDownBy=1.0 disables the Android WebRTC quality scaler.
          // Without REMB from the receiver, BWE stays at minimum and the encoder
          // downgrades resolution to ~320x192 permanently. Lock it to 1:1.
